...
## [0.15.0] - [0.15.42] - 2026-05-23

### Changed

- Update assets list
- Bump `pdfjs-dist` dependency
...
- Improve regular expression for stock events

## [0.14.7] - [0.14.299] - 2025-05-06

### Fixed

- Fix NuBank notes without stock type in the code name
...
- Improve regular expression handling asset's kind, event, and governance level

### Changed

- `NoteParser().assetCrawler.getCodeFromTitle` accepts a second argument as being the kind of the asset (like `PN`, `ON`, etc)

## [0.12.0] - [0.12.80] - 2025-01-28
...
- Removed TS formatter

## [0.10.129] - [0.10.267] - 2024-08-03

### Fixed

- Fix HTTPs request error on getting updates

### Changed

- Update assets list

## [0.10.2] - [0.10.128] - 2024-01-12
